...
func TestResolveEmpty(t *testing.T) {
	_, err := Resolve(client, "", EthereumMainnet)
	assert.NotNil(t, err, "Resolved empty name")
}

func TestResolveZero(t *testing.T) {
	_, err := Resolve(client, "0", EthereumMainnet)
	assert.NotNil(t, err, "Resolved empty name")
}

func TestResolveNotPresent(t *testing.T) {
	_, err := Resolve(client, "sirnotappearinginthisregistry.eth", EthereumMainnet)
...
func TestResolveBadResolver(t *testing.T) {
	_, err := Resolve(client, "resolvestozero.eth", EthereumMainnet)
...
func TestResolveTestEnsTest(t *testing.T) {
	...
	actual, err := Resolve(client, "test.enstest.eth", EthereumMainnet)
...
func TestResolveResolverEth(t *testing.T) {
	...
	actual, err := Resolve(client, "resolver.eth", EthereumMainnet)
	require.Nil(t, err, "Error resolving name")
	assert.Equal(t, expected, hex.EncodeToString(actual[:]), "Did not receive expected result")
}
...
func TestResolveEthereum(t *testing.T) {
	...
	actual, err := Resolve(client, "ethereum.eth", EthereumMainnet)
	require.Nil(t, err, "Error resolving name")
	assert.Equal(t, expected, hex.EncodeToString(actual[:]), "Did not receive expected result")
}
...
func TestResolveAddress(t *testing.T) {
	...
	actual, err := Resolve(client, "0xb8c2C29ee19D8307cb7255e1Cd9CbDE883A267d5", EthereumMainnet)
...
func TestResolveShortAddress(t *testing.T) {
	...
	actual, err := Resolve(client, "0x1", EthereumMainnet)
	require.Nil(t, err, "Error resolving address")
	assert.Equal(t, expected, hex.EncodeToString(actual[:]), "Did not receive expected result")
}

func TestResolveHexString(t *testing.T) {
	_, err := Resolve(client, "0xe32c6d1a964749b6de2130e20daed821a45b9e7261118801ff5319d0ffc6b54a", EthereumMainnet)
...
func TestReverseResolveTestEnsTest(t *testing.T) {
	...
	actual, err := ReverseResolve(client, address, EthereumMainnet)
	require.Nil(t, err, "Error resolving address")
